...
export default function Examples(props: ExamplesProps) {
    ...
    const examples = [
        ...
        { query: "Note counts per note status ", description: "Shows note counts per note status", icon: TableIcon },
        { query: "Statuses rated helpful ", description: "Shows note counts per note status", icon: TableIcon },
    ];
